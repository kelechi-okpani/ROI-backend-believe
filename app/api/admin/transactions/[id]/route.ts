...
export async function PATCH(req: NextRequest, { params }: RouteParams) {
  try {
    ...
    // Save with validateBeforeSave: false to bypass schema requirements for legacy/missing fields
    ...
    await createNotification(
      ...
      `Your ${transaction.type.toLowerCase()} request of $${transaction.amount} has been ${statusLabel.toLowerCase()}.`,
    ...
    return corsResponse({ error: error.message || "Internal ledger processing failure" }, 500, req);
  }
}
